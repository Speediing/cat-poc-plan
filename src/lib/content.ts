...
export const content: SiteContent = {
  ...
  howWeRunIt: {
    ...
    days: [
      {
        when: "Day 1 · Mon",
        stage: "Write the checks",
        headline: "",
        bullets: [
          "Get Daniela and Kevin's people. Charlie knows. Olivier keeps it moving.",
          "Workspaces on.",
          "Write what a good photo is: sharp enough, right part in frame, no finger on the lens.",
          "Put it in a real ticket so we don't start with a half-spec.",
        ],
      },
      {
        when: "Day 2 · Tue",
        stage: "Agree the design",
        headline: "",
        bullets: [
          "One day, not months.",
          "How this becomes a shared check Cat Inspect and Spotters Guide can call later.",
          "Write the review and security rules now so Friday isn't a surprise.",
          "Same repo.",
        ],
      },
      {
        when: "Day 3 · Wed",
        stage: "Build it where they already work",
        headline: "",
        bullets: [
          "Same repos and PRs. Not a demo they will throw away.",
          "Agents take the ticket and open PRs people can actually review.",
        ],
      },
      {
        when: "Day 4 · Thu",
        ...
        headline: "",
        bullets: [
          "Review the PR against Monday's checks and Tuesday's rules.",
          "One ticket. Nobody starts over.",
          "MLOps sees it while it's still the same work.",
        ],
      },
      {
        when: "Day 5 · Fri",
        stage: "Show the checks. Decide.",
        headline: "",
        bullets: [
          "Demo the photos, not a slide.",
          "Cost is a real number.",
          "Decide if this way of working is worth doing again.",
        ],
      },
    ],
  },
  ...
  whatWeProve: {
    ...
    outcomes: [
      ...
      "That unlocks parts ID, visual anomaly, and repair-cost estimate.",
      "Requirements, prototype, and eng handoff stay on one ticket so the next team can copy it. Not another throwaway demo.",
      "Token cost is a real number, not a guess.",
    ],
  },
